...
To extract the green channel of the pixels in the face, the ROI (Region of Interest) of each frame was obtained with the **detect_roi()** fucntion. In order to reduce errors at the beginning of the recording, the first 10 seconds of the video were excluded. The green channel of the ROI was extracted, and the average value of the normalized channel was then added to the variable that contains the signal. 
